...
| 2026-07-13 | Run 9 (`run9_seed2_stripFALSE_baseRM2_180`) | — | launched | 2nd independent seed of the Run 8 config (GPU2,3, ports 8710) to confirm the +1.36 / turn-taking result is not seed noise (paper robustness). |
